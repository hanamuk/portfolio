...
public class PasswordFindData {
    ...
    public void SetPwd_find_fail(int find_fail){this.pwd_find_fail= find_fail;};
    ...
    public void SetRIGIN_ACCOUNT_MEMBERNAME(String m_name){this.ORIGIN_ACCOUNT_MEMBERNAME =m_name;};
    ...
    public String GetORIGIN_ACCOUNT_PASSWORD(){ return this.ORIGIN_ACCOUNT_PASSWORD;};
    public int Getpwd_find_fail(){ return this.pwd_find_fail;};
